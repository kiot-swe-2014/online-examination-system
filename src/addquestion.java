...
public class addquestion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/onlineexamination/system/Add new question.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/onlineexamination/system/clear.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String answer=jTextField6.getText();
         try{
             Connection con=connectionprovider.getCon();
                PreparedStatement ps = con.prepareStatement("INSERT INTO question(id,name,option1,option2,option3,option4,answer) VALUES(?,?,?,?,?,?,?)");
                ps.setString(1,id);
                ps.setString(2,name);
                ps.setString(3,opt1);
                ps.setString(4,opt2);
